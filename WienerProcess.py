...
import sympy
dtype = [('Date', 'U10'),('Close/Last','f8'), ('Open','f8'), ('High','f8'), ('Low','f8'),   ]
data = np.genfromtxt('HistoricalData_1717244350919.csv', delimiter = ',', dtype=dtype, names=True, encoding ='utf-8')
# data = np.transpose(data)
print(data.dtype)
open_prices = data['Open']
close_prices = data['CloseLast']

interlaced = np.empty((open_prices.size + close_prices.size), dtype = open_prices.dtype)
